...
<body>
  <header>
    <div class="logo">
        <a href="index.php"><span>LACE </span>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/bookflix/index.php#New">New Arrived</a>
                <a href="http://localhost/bookflix/index.php#Adventure">SNEAKERS</a>
                <a href="http://localhost/bookflix/index.php#Magical">FLIP-FLOPS</a>
                <a href="http://localhost/bookflix/index.php#Knowledge">RUNNING SHOES</a>
